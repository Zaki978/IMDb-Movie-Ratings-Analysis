...
- **Converting columns** to the appropriate data types. All columns in the titles.basic table were of object data type and were correctly reformated to numerical, strings and boolean data types
